<?php
    ...
    require "/www/wwwroot/jawnho.xyz/PHPtest/ver3/sqlHandler.php";
    ...
    function imageStore($con, $username, $base64_content) {
        ...
        $sql = "INSERT INTO ".image_table.
            "(username,pic_values)(SELECT '$username','$base64_content')";
        $sql .= "on DUPLICATE KEY UPDATE ";
        $sql .= image_table.".username='$username', ";
        $sql .= image_table.".pic_values='$base64_content';";
        try {
        ...
        # echo $sql;
        $stmt->bindParam(1, $base64_content);
        $stmt->execute();
        return true;
    }

    function imageLoad($con, $username) {
        /* 
         * $con: 数据库连接实例
         * 返回: 存储的所有图片内容
         */
        ...
        foreach ($con->query($sql) as $row) {
            array_push($img_list, $row["pic_values"]);
        }
        return $img_list;
    }
